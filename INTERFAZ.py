...
boton_param_faltantes_a4 = tk.Button(root, text='Buscar Parámetros faltantes Tabla Horaria A4',
                                     command=ejecutar_param_faltantes_a4)
boton_revisar_horarios = tk.Button(root, text='Revisar horarios de Tabla Horaria y Anexo 1',
                                   command=ejecutar_revisar_horarios)
comparar_salidas_a3a4 = tk.Button(root, text='Comparar salidas entre Anexo 3 y Anexo 4 (Tabla horaria)',
                                  command=ejecutar_contar_salidas)
comparar_capacidades_a3a4 = tk.Button(root,
                                      text='Comparar capacidad entre Anexo 3 y Anexo 4 (Tabla horaria y Diccionario)',
                                      command=ejecutar_revisar_cap)
boton_revisar_intervalos = tk.Button(root, text='Revisar intervalos Tabla Horaria',
                                     command=ejecutar_revisar_intervalos)
